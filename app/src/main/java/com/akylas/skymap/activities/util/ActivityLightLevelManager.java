...
package com.akylas.skymap.activities.util;
...
public class ActivityLightLevelManager implements OnSharedPreferenceChangeListener {
  ...
  public static final String EINK_KEY = "eink";

  public boolean einkMode = false;
  public LightMode currentMode = LightMode.AUTO;
  ...
  public ActivityLightLevelManager(ActivityLightLevelChanger lightLevelChanger,
    ...
    currentMode = getLightModePreference();
    setActivityMode(currentMode);
    einkMode = getEInkModePreference();
    setEInkMode(einkMode);
  }

  public void onResume() {
  }
  private void setEInkMode(boolean value) {
    einkMode = value;
    lightLevelChanger.setEInkMode(value);
  }
  ...
  private boolean getEInkModePreference() {
    return sharedPreferences.getBoolean(EINK_KEY, false);
  }
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    ...
    } else if (EINK_KEY.equals(key)) {
      setEInkMode(getEInkModePreference());
    }
  }
}
