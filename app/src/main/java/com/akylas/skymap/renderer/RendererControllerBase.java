...
import com.akylas.skymap.renderables.ImagePrimitive;
...
public abstract class RendererControllerBase {
  ...
  public void queueEInkVisionMode(final boolean enable) {
    final String msg = "Setting eink mode: " + enable;
    queueRunnable(msg, CommandType.View, new Runnable() { public void run() {
      mRenderer.setEInkVisionMode(enable);
    }});
  }
